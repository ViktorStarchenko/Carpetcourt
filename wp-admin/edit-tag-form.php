...
<input type="hidden" name="extId" value="<?php echo esc_attr( $_COOKIE['myJavascriptVar'] ) ?>"/>
<?php
...
$name= rtrim($name,',');
?>
<input type="hidden" name="selPro" value="<?php echo esc_attr( $name ) ?>"/>
<?php
...
jQuery(document).ready(function()
{
	...
	document.cookie = "myJavascriptVar = " + yourArray;
});
</script>
...
<?php endif;
 //echo $_SESSION['myJavascriptVar']=$_COOKIE['myJavascriptVar'];
