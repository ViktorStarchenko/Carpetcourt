    ...
    <div class="container">
     <div class="row">
      <div class="col-sm-12 col-md-10 col-md-offset-1 ">
       <ul id="progressbar">
        <li class="li-sell active current" id="li-id-sell">
         <h3 class="alt-text cc-effect-1"><a class="cpm-first-steps" href="#" id="cpm-sell"><span><?php _e('Sell','cc_filter_product');?></span></a></h3>
...
<div class="container">
 <div class="row">
  <div class="col-sm-12 col-md-10 col-md-offset-1 ">
   <div class="progressbar-life-desc text-center sell-qns">
    <h3>What kind of home do you have?</h3>
  </div>

  <?php
  if ( !empty( $field_blurb[0]['text_content_blurb'] ) ) { ?>
...
<div id="msform">
  ...
  <div class="container-fluid  cpm-container-fluid ">
    <!-- fieldsets -->

    <fieldset data-index="1" class="cpm-pa_sell">
     <ul class="cc_filter full-width-filter sell">
      <?php cc_cpm_filter_template_loop('pa_sell'); ?>
    </ul>
    <input type="hidden" name="pa_rent" id="cc_sell"/>
