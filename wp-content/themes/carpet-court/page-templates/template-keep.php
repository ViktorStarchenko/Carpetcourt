...
?>
<div class="custom-separator-50"></div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-10 col-md-offset-1 ">
                ...
                <div class="progressbar-life-desc text-center floor-qns">
                    <h3>What stage of life are you at?</h3>
                </div>
...
<div id="msform">
    ...
    <div class="col-sm-12 pad0lr-xs">
        <fieldset data-index="0" class="cpm-pa_floor">

            <ul class="cc_filter full-width-filter floor">
        ...
        <fieldset data-index="1" class="cpm-pa_style">
            <ul class="cc_filter full-width-filter style">
                <?php cc_filter_template_loop('pa_style'); ?>
            </ul>
            <input type="hidden" name="cc_style" id="cc_style"/>

            <a href="#" class="previous style-previous action-button">
                <span class="fa fa-5x fa-angle-left"></span>
