...
class Woo_brand {	
	...
	public function __construct() {	
		...
		add_action( 'init', array($this,'cc_brand_register') );
		// Add form
		add_action( 'product_brand_add_form_fields', array( $this, 'add_taxonomy_fields' ) );
		add_action( 'product_brand_edit_form_fields', array( $this, 'edit_taxonomy_fields' ), 10 );	

		// Add columns
		add_filter( 'manage_edit-product_brand_columns', array( $this, 'product_taxonomy_columns' ) );
		add_filter( 'manage_product_brand_custom_column', array( $this, 'product_taxonomy_column' ), 10, 3 );
		...
		add_action('delete_product_brand', array( $this, 'delete_taxonomy_fields') );
	 ...
	 */
	public function cc_brand_register(){
			$labels = array(
				'name'					=> _x( 'Brands', 'Brands', 'carpet-court' ),
				'singular_name'			=> _x( 'Brand', 'Brand', 'carpet-court' ),
				'search_items'			=> __( 'Search Brands', 'carpet-court' ),
				'all_items'				=> __( 'All Brands', 'carpet-court' ),
				'parent_item'			=> __( 'Parent Brand', 'carpet-court' ),
				'parent_item_colon'		=> __( 'Parent Brand', 'carpet-court' ),
				'edit_item'				=> __( 'Edit Brand', 'carpet-court' ),
				'update_item'			=> __( 'Update Brand', 'carpet-court' ),
				'add_new_item'			=> __( 'Add New Brand', 'carpet-court' ),
				'new_item_name'			=> __( 'New Brand Name', 'carpet-court' ),
				'menu_name'				=> __( 'Brands', 'carpet-court' ),
			);
	...
	public function delete_taxonomy_fields($term, $tt_id, $delete_term){
		delete_term_meta( $term, 'thumbnail_id' );
		// delete_term_meta( $term_id, 'related_post_id' ); 
	}
...
add_action( 'after_setup_theme', array( 'Woo_brand', 'get_instance' ) );