...
<?php else: ?>
	...
	<a href="#" class="cpm_<?php echo $link_classes ?> open-pretty-photo" data-product-id="<?php echo $product_id ?>" data-product-type="<?php echo $product_type?>" data-wishlist-id="0" data-wishlist-visibility="0">
		<?php echo $icon ?>
	    <?php echo $label ?>
	</a>
	        ...
	        <div class="yith-wcwl-popup-content">
	            ...
	            <div class="yith-wcwl-first-row">
	                <div class="yith-wcwl-wishlist-select-container">
	                    <h3>My Wishlist<?php //echo $popup_title ?></h3>
	                    <span class="cpm-text">My Wishlist</span>
	                    <select name="wishlist_id" class="wishlist-select" style="display: none;">
