...
<main class="g-main">
    ...
    <div class="packaging-product">
        <div class="crumps">
            <ul class="crumps-list" style="margin-left: 0;">
                <li class="crumps-list__item"><a href="<?= home_url() ?>">home</a></li>
                <li class="crumps-list__item"><a href="<?= get_category_link($cat->term_id); ?>" style="text-transform: lowercase"><?= $cat->name; ?></a></li>
                <li class="crumps-list__item"><span>product page</span></li>
            </ul>
        </div>
