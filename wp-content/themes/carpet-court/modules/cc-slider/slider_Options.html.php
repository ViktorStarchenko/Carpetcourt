...
{
    ?>
	<?php $path_site = get_stylesheet_directory_uri()."/modules/cc-slider/Front_images"; ?>
	<style>
.options-block h3{
	display: block;
    text-align: center;
		...
		<div id="poststuff">
			...
			<div id="post-body-content" class="slider-options">
				...
				<div id="slider-options-list">					
					<form action="admin.php?page=cc_slider_options" method="post" id="adminForm" name="adminForm">
						...
						<div id="post-body-footer">
							...
							<input type="hidden" name="task" value="<?php echo isset($param_values)?'save':''?>" />
							<input type="hidden" name="controller" value="options"/>
							<input type="hidden" name="op_type" value="styles"/>
							<input type="hidden" name="boxchecked" value="0"/>

							<!-- <a onclick="document.getElementById('adminForm').submit()" class="save-slider-
							options button-primary">Save</a> -->
							<button type="submit" class="save-slider-options button-primary">Save</button>
							<div class="clear"></div>
							<script>
									jQuery(document).ready(function ($) {
