        ...
        */
        ...
        private function check_icon_font_usage() {
            ...
            if ( ( version_compare( $wp_version, '3.8', '>=' ) == TRUE ) ) {
                ...
                wp_enqueue_style( 'wpsl-admin-38', WPSL_URL.'admin/css/style-3.8'. $min .'.css', false );
            }
        }
		...
		public function admin_scripts() {
            ...
            wp_enqueue_script( 'wpsl-admin-js', WPSL_URL.'admin/js/wpsl-admin'. $min .'.js', array( 'jquery' ), WPSL_VERSION_NUM, true );
            ...
            if ( ( get_post_type() == 'wpsl_stores' ) || ( isset( $_GET['post_type'] ) && ( $_GET['post_type'] == 'wpsl_stores' ) ) ) {
                ...
                wp_enqueue_style( 'wpsl-admin-css',WPSL_URL.'admin/css/style'. $min .'.css', false );
                ...
                wp_enqueue_script( 'wpsl-queue',WPSL_URL.'admin/js/ajax-queue'. $min .'.js', array( 'jquery' ), WPSL_VERSION_NUM, true );
                wp_enqueue_script( 'wpsl-retina', WPSL_URL.'admin/js/retina'. $min .'.js', array( 'jquery' ), WPSL_VERSION_NUM, true );
