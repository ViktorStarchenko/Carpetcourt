...
$imported_images = get_field('gallery_images');
 ...
 //print_r($imported_tags);
if ( !empty( $imported_images[0]['gallery_images_url'] ) ) {  //print_r($imported_images);?>
    ...
    <div class="<?php echo $this->slug; ?>-images-wrap">
       ...
       <div class="<?php echo $this->slug; ?>-images <?php if( $jck_wt['clickAnywhere'] ) echo $this->slug."-images--click_anywhere"; ?>">
           ...
           <input type="hidden" class="hidden-img-url" value="<?php echo $import_image['gallery_images_url']; ?>"></input>
             ...
             <a data-pin-do="buttonPin" data-share-url="<?php echo esc_url(get_permalink()); ?>" data-share-description="<?php echo get_the_title(); ?>" data-share-tag="<?php echo get_field('feature_tag'); ?>" data-share-media="<?php echo $import_image['gallery_images_url']; ?>" class="cpm-pin-it" href="https://www.pinterest.com/pin/create/button/?url=<?php echo esc_url(get_permalink()); ?>&media=<?php echo $import_image['gallery_images_url']; ?>&description=<?php echo get_the_title(); ?>" data-pin-custom="true"><i class="fa fa-pinterest fa-3" aria-hidden="true"></i></a>
             <div class="color-term-name ts-term" style="display:table;"><span class="term-span"><?php echo get_the_title(  $post_id )?></span></div>
...
<?php
    ...
    <div class="<?php echo $this->slug; ?>-images-wrap">
       ...
       <div class="<?php echo $this->slug; ?>-images <?php if( $jck_wt['clickAnywhere'] ) echo $this->slug."-images--click_anywhere"; ?>">
           ...
           <div class="<?php echo $this->slug; ?>-images__slide <?php if($i == 0) echo $this->slug."-images__slide--active"; ?>" data-index="<?php echo $i; ?>">
<input type="hidden" class="hidden-img-url" value="<?php echo $image['large'][0]; ?>"></input>
             ...
             <a data-pin-do="buttonPin" data-share-url="<?php echo esc_url(get_permalink()); ?>" data-share-description="<?php echo $image['alt'] ?>" data-share-tag="<?php echo get_field('feature_tag'); ?>" data-share-media="<?php echo $image['large'][1]; ?>" class="cpm-pin-it" href="https://www.pinterest.com/pin/create/button/?url=<?php echo esc_url(get_permalink()); ?>&media=<?php echo $image['large'][1]; ?>&description=<?php echo $image['alt']; ?>" data-pin-custom="true"><i class="fa fa-pinterest fa-3" aria-hidden="true"></i></a><div class="color-term-name"></div>
             <?php /*if ( is_user_logged_in() && is_numeric( $default_image_ids[$i] ) && !empty( $default_image_ids[$i] ) ) {
