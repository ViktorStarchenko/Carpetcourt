			...
			<div id="review_form">
				<?php
					...
					$comment_form['comment_field'] .= '<div class="comment-form-comment"><label for="comment">' . esc_html__( 'Your review', 'woocommerce' ) . ' <span class="required">*</span></label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true" required></textarea></div>';
						...
						// $comment_form['comment_field'] .= '<div class="comment-form-captcha"><script src="//www.google.com/recaptcha/api.js"></script><div class="g-recaptcha" data-theme="light" data-sitekey="6Lel4pIUAAAAAALATY2GVzCuDxrddZIF4c8enPSV"></div></div>';
